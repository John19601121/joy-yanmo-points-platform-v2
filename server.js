...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","Noto Sans TC",sans-serif;background:var(--paper);color:var(--ink);letter-spacing:0}
    a{color:inherit}.shell{min-height:100vh;display:grid;grid-template-columns:260px 1fr}.side{background:#fff;border-right:1px solid var(--line);padding:24px;position:sticky;top:0;height:100vh}.side-head{display:block}.nav-toggle{position:absolute;inline-size:1px;block-size:1px;opacity:0;pointer-events:none}.nav-toggle-button{display:none}.brand{display:flex;gap:12px;align-items:center;margin-bottom:28px}.brand img{width:54px;height:54px;object-fit:contain}.brand b{display:block;font-size:18px}.brand span{color:var(--muted);font-size:13px}nav{display:grid;gap:8px}nav a,nav button,.button{border:1px solid transparent;background:transparent;text-decoration:none;border-radius:8px;padding:11px 12px;font-size:15px;text-align:left;cursor:pointer}nav a:hover,nav button:hover,.button:hover{background:var(--jade)}nav form{margin-top:16px}.main{padding:30px;max-width:1240px;width:100%;margin:auto}.top{display:flex;justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:22px}.kicker{color:var(--gold);font-weight:700;font-size:13px}.top h1{margin:4px 0 0;font-size:30px}.user{color:var(--muted);font-size:14px}.grid{display:grid;gap:16px}.cards{grid-template-columns:repeat(4,minmax(0,1fr))}.card,.panel{background:#fff;border:1px solid var(--line);border-radius:8px;padding:18px}.metric{color:var(--muted);font-size:14px}.metric strong{display:block;color:var(--deep);font-size:30px;margin-top:8px}.table{width:100%;border-collapse:collapse;background:#fff;border:1px solid var(--line);border-radius:8px;overflow:hidden}.table th,.table td{text-align:left;padding:13px 14px;border-bottom:1px solid var(--line);vertical-align:top}.table th{background:#f5f7f3;color:#52615c;font-size:13px}.table tr:last-child td{border-bottom:0}.actions{display:flex;gap:8px;flex-wrap:wrap}.button{display:inline-flex;align-items:center;justify-content:center;background:var(--deep);color:#fff;border-color:var(--deep);min-height:40px}.button.secondary{background:#fff;color:var(--deep);border-color:var(--line)}.button.danger{background:#7f2f2f;border-color:#7f2f2f}form.stack{display:grid;gap:14px;max-width:620px}.field{display:grid;gap:6px}.field label{font-weight:700;font-size:14px}.field input,.field select,.field textarea{border:1px solid var(--line);border-radius:8px;padding:12px 13px;font:inherit;background:#fff}.field textarea{min-height:90px}.login{min-height:100vh;display:grid;grid-template-columns:minmax(360px,480px) 1fr;background:#fff}.login-card{padding:44px;display:flex;flex-direction:column;justify-content:center}.login-card .brand img{width:70px;height:70px}.hero{background:url("/public/hero-business.png") center/cover no-repeat;position:relative}.hero:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(255,255,255,.18),rgba(255,255,255,0))}.notice{padding:12px 14px;background:var(--jade);border:1px solid #d5e4db;border-radius:8px;margin-bottom:16px;color:#35534a}.empty{background:#fff;border:1px dashed var(--line);border-radius:8px;padding:28px;color:var(--muted)}.split{grid-template-columns:1.1fr .9fr}.badge{display:inline-block;border:1px solid var(--line);border-radius:999px;padding:4px 9px;font-size:12px;color:#52615c;background:#fff}.muted{color:var(--muted)}
    @media(max-width:860px){.shell{display:block}.side{position:sticky;z-index:20;top:0;height:auto;padding:10px 16px;border-right:0;border-bottom:1px solid var(--line);box-shadow:0 3px 14px rgba(25,54,47,.08)}.side-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.brand{margin:0;min-width:0}.brand img{width:42px;height:42px}.brand b{font-size:16px}.brand span{font-size:12px}.nav-toggle-button{display:inline-flex;align-items:center;justify-content:center;flex:0 0 44px;width:44px;height:44px;border:1px solid var(--line);border-radius:8px;background:#fff;color:var(--deep);font-size:24px;line-height:1;cursor:pointer}.nav-toggle-button:before{content:"☰"}.nav-toggle:focus-visible+.side-head .nav-toggle-button{outline:3px solid rgba(185,150,77,.45);outline-offset:2px}.side nav{display:none;max-height:calc(100vh - 74px);overflow-y:auto;padding:12px 0 6px}.nav-toggle:checked~nav{display:grid}.nav-toggle:checked+.side-head .nav-toggle-button:before{content:"×"}.side nav a,.side nav button{display:flex;align-items:center;min-height:44px;width:100%}.side nav form{margin-top:8px}.main{padding:20px 16px;overflow:hidden}.cards,.split{grid-template-columns:1fr}.login{grid-template-columns:1fr}.login-card{padding:28px 20px}.hero{display:none}.top{display:block;margin-bottom:18px}.top h1{font-size:26px;line-height:1.25}.user{margin-top:6px}.card,.panel{padding:16px}.metric strong{font-size:26px}.table{display:block;max-width:100%;overflow-x:auto;font-size:14px;-webkit-overflow-scrolling:touch}.table th,.table td{padding:12px;white-space:nowrap}.button,nav a,nav button{min-height:44px}.actions{gap:10px}}
  </style>
</head>
<body>
  <div class="${user ? "shell" : ""}">
    ${user ? `<aside class="side"><input class="nav-toggle" id="mobile-nav-toggle" type="checkbox" aria-label="開啟導覽選單"><div class="side-head"><div class="brand"><img src="/public/logo.png" alt="LT Logo"><div><b>LT 大健康成交</b><span>會員積分管理平台</span></div></div><label class="nav-toggle-button" for="mobile-nav-toggle" aria-label="切換導覽選單"></label></div>${nav(user)}</aside>` : ""}
